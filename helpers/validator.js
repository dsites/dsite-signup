...
const accountNotExist = (rule, value, callback) => {
    dpay.api.getAccounts([value], (err, result) => {
        if (result[0]) {
 ...
 * See
 * https://github.com/dsites/dsite-frontend/blob/eaf8a02658b8deaef376ec90b81d0866e52582cc/app/utils/ChainValidation.js#L4
 *
 * @param {string} name
 * @return {boolean}
 */
