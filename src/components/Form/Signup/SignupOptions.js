    ...
    return (
        <div>
            ...
            >
                ...
                <a
                    className="external-link"
                    href="https://dsite.io/news/@dsiteblog/new-tool-from-dsocial-io-create-new-dpay-blockchain-accounts-with-dpayid"
                    onClick={() => {
                        logCheckpoint(
                            CHECKPOINTS.paid_signup_clicked_dpayid
                        );
                    }}
                >
                    <Button type="primary" ghost htmlType="button">
                ...
                <p>
                    <FormattedMessage id="signup_options_dpayid" />
                </p>
                <hr />
